...
**Why.** Confident-but-wrong is the dominant failure mode of fast AI-assisted work. Rule 3 says verify before you endorse; this rule says *when trust is warranted* — the gap Rule 3 leaves open. Without a stopping criterion, "I verified" silently becomes a rubber stamp the moment the first plausible pass comes back clean. The honest criterion is observed convergence, not effort spent or time elapsed.
