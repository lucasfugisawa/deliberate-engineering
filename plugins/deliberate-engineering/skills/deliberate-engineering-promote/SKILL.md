...
Lenses are `### N. Title` blocks followed by three bullets (How it works / Objective / When most valuable), grouped into Parts (lettered sections like "Part A: Process / Meta-review Strategies"). The operation in the candidate frontmatter determines what to do.
