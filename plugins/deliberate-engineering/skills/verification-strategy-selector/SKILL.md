...
The reference for every strategy cited below is `catalog.md` in this directory (21 strategies in five groups + composition patterns). Read **only** the sections you select — progressive disclosure, not the whole file.
