---
description: Deliberately select and apply the right communication lenses for the artifact and audience at hand
argument-hint: Optional artifact or audience (e.g., "PR description", "review comment", "message to product")
---

# Deliberate Communication

Invoke the `communication-collaboration-selector` skill.
