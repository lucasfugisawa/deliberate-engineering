---
description: "Capture generalizable judgment from this session into a clean catalog candidate: generalized, discussed, and written to the contribution queue (never committed)"
argument-hint: Optional focus (e.g., "the review approach", "how we verified", a path)
---
