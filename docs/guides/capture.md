...
4. **[Agent → You]** Presents each candidate one at a time: the observed signal, the target, and the exact markdown block that would be appended, then asks: approve, edit, or reject?
